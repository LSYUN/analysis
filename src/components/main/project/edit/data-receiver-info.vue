        ...
        operations: {
          add: {
            ...
            confirm: function (info) {
              console.log(info);
              window.appContext.http.pushServerIntemAdd(info).then((response) => {
                this.$route.router.go({path: '/project/edit/dataReceiver'});
                toastr.info('添加成功!');
              }, (response) => {
                toastr.error('通信失败');
              });
          ...
          modify: {
            ...
            path: 'modify',
            confirm: function (info) {
              window.appContext.http.pushServerItemModify(info).then((response) => {
                this.$route.router.go({path: '/project/edit/dataReceiver'});
                toastr.info('修改成功!');
              }, (response) => {
                toastr.error('通信失败');
