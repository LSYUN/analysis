  ...
  <div class="box box-warning">
    <div class="box-body">
      ...
      <div class="div-margin-bottom">
        ...
        <div class="col-xs-12 col-sm-3 div-grid">
      ...
      return {
        ...
        selectedTimes: {
          ...
          ajaxUrl: function (data) {
            return window.appContext.urls.getVdataByMonitorItemId(this.monitorItemId);
          }.bind(this)
        },
...
//      })
    ...
    methods: {
      initNecessaryPeriod(monitorItemId){
        window.appContext.http.getParamById(monitorItemId).then((response) => {
          ...
          if (!$.isEmptyObject(data)) {
            ...
            this.$refs.selectedSelector.$emit('clear');
      ...
      confirm () {
        ...
        if (this.itemParam.hasOwnProperty('id')) {
          ...
          window.appContext.http.insertOrUpdate(info).then((response) => {
...
//        }
      ...
      deleteById(){
        if (this.itemParam.id) {
          window.appContext.http.deleteById(this.itemParam.id).then((response) => {
            let self = this;
            layer.open({
              icon: 3,
