...
//          serverSide: true,
          ...
          deferRender: true,
          ajax: {
            url: window.mainConfig.url.getDataReceiverPage(this.projectId),
//            url:'',
            type: 'GET',
...
//        this.itemInfo.sequence = this.sequence;
        this.$router.push({path: '/project/edit/dataReceiverInfo/add'});
      },
      modifyInfo(){
        ...
        $('#pushServerItem tbody').on('click', 'td:nth-child(7)', function (p) {
          ...
          component.$router.push({path: '/project/edit/dataReceiverInfo/modify'});
        });
      },
      deletePushServer(){
        const component = this;
        $('#pushServerItem tbody').on('click', 'td:nth-child(8)', function (p) {
          ...
          layer.open({
            ...
            yes: function (index, layero) {
              window.mainConfig.http.pushServerItemDelete(JSON.stringify(oneId)).then((response) => {
