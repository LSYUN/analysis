...
<script>
  export default {
//    components: {
//      'analysis': require('../utility/analyse-chart.vue'),//渗流量 11
//    },
    props: {
      info: {
        type: Object,
...
//          totalTitle: '渗流量',
//          xTitle: '时间',
//          yTitle: this.info.itemOption.attrText || '值',
//          ajaxData: this.seriesOptions,
//        };
//        this.isRender = true;
//      }
//    },
    ...
    methods: {
      ...
      createChart() {
        ...
        this.getChartOptions(this.info.itemOption.attrText, this.info.itemOption.attrUnit,this.info.itemOption.mark).title.text = '渗流线监测';
...
//              });
      ...
      getChartOptions(text, unit,mark){
        return {
          ...
          title: {text: '渗流线监测', style: {color: '#7cb5ec', fontSize: '1.8em', fill: '#7cb5ec'}},
          subtitle:{
