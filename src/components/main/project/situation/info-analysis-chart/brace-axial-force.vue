...
<script>
  export default {
//    components: {
//      'analysis': require('../utility/analyse-chart.vue'),//轴力 3
//    },
    props: {
      info: {
        type: Object,
...
//          console.log(response);
      ...
      createChart() {
        ...
        this.getChartOptions(this.info.itemOption.attrText, this.info.itemOption.attrUnit, this.info.itemOption.mark).title.text = '轴力监测';
...
//              });
      ...
      getChartOptions(text, unit, mark){
        return {
          ...
          title: {text: '轴力监测', style: {color: '#7cb5ec', fontSize: '1.8em', fill: '#7cb5ec'}},
          subtitle: {
