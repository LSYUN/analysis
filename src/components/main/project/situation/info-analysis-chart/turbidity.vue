...
//        e.startEndDate.startDate.dateL, e.startEndDate.endDate.dateL);
    ...
    methods: {
//      filterByPointAndTime(variety, attrY, projectId, pointNames, startTime, endTime, pageIndex){
...
//              });
      ...
      getChartOptions(text, unit,mark){
        return {
          ...
          title: {text: '浊度监测', style: {color: '#7cb5ec', fontSize: '1.8em', fill: '#7cb5ec'}},
          subtitle:{
