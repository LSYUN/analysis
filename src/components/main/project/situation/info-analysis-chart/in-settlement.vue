...
<script>
  export default {
//    components: {
//      'analysis': require('../utility/analyse-chart.vue'),//内部沉降 19
//    },
    props: {
      info: {
        type: Object,
...
//        e.startEndDate.startDate.dateL, e.startEndDate.endDate.dateL);
    ...
    methods: {
      ...
      createChart() {
        ...
        this.getChartOptions(this.info.itemOption.attrText, this.info.itemOption.attrUnit,this.info.itemOption.mark).title.text = '内部沉降监测';
...
//              });
      ...
      getChartOptions(text, unit,mark){
        return {
          ...
          title: {text: '内部沉降监测', style: {color: '#7cb5ec', fontSize: '1.8em', fill: '#7cb5ec'}},
          subtitle:{
