...
<script>
  export default {
//    components: {
//      'analysis': require('../utility/analyse-chart.vue'),//应力 11
//    },
    props: {
      info: {
        type: Object,
...
//        variety: 'stressData',
    ...
    methods: {
      ...
      createChart() {
        ...
        this.getChartOptions(this.info.itemOption.attrText, this.info.itemOption.attrUnit,this.info.itemOption.mark).title.text = '应力监测';
...
//              });
      ...
      getChartOptions(text, unit,mark){
        return {
          ...
          title: {text: '应力监测', style: {color: '#7cb5ec', fontSize: '1.8em', fill: '#7cb5ec'}},
          subtitle:{
