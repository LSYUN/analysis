...
<script>
  export default {
//    components: {
//      'analysis': require('../utility/analyse-chart.vue'),//测缝计 裂缝 6
//    },
    props: {
      info: {
        type: Object,
...
//              this.chart.hideLoading();
      ...
      createChart() {
        ...
        this.getChartOptions(this.info.itemOption.attrText, this.info.itemOption.attrUnit,this.info.itemOption.mark ).title.text = '裂缝监测';
...
//              });
      ...
      getChartOptions(text, unit,mark){
        return {
          ...
          title: {text: '裂缝监测', style: {color: '#7cb5ec', fontSize: '1.8em', fill: '#7cb5ec'}},
          subtitle:{
