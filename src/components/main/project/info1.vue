...
//      ...mapState({
//        info: state => {
//          let temp = Object.assign({}, state.listInfo.info);
//          return temp && temp.id ? temp : Object.assign({}, window.session.getObj(window.sessionKeys.TEMPINFO));
//        }
//      }),
//      operation () {
...
//    },
    ...
    mounted () {
      ...
      $('#test').click(function () {
        ...
        _this.$router.push({path: '/project/list'});
      });
