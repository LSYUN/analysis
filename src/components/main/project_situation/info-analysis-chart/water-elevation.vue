...
<script>
  export default {
//    components: {
//      'analysis': require('../utility/analyse-chart.vue'),//高程水准 15
//    },
    props: {
      info: {
        type: Object,
...
//              this.chart.hideLoading();
      ...
      createChart() {
        ...
        this.getChartOptions(this.info.itemOption.attrText, this.info.itemOption.attrUnit,this.info.itemOption.mark).title.text = '高程水准监测';
...
//              });
      ...
      getChartOptions(text, unit,mark){
        return {
          ...
          title: {text: '高程水准监测', style: {color: '#7cb5ec', fontSize: '1.8em', fill: '#7cb5ec'}},
          subtitle:{
