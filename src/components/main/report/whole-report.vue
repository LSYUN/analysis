      ...
      <div class="box-body">
        ...
        <div class="box-body">
          ...
          <div class="row">
            ...
            <div class="col-md-offset-9 div-grid btn-container">
  ...
  export default {
      ...
      return {
        ...
        periodOptions: {
          ...
          ajaxUrl: function () {
            ...
            return window.appContext.urls.getPeriodNoByProjectIdAndTime(this.projectId, this.startTime, this.endTime);
          }.bind(this)
        },
        referencePeriodOptions: {
          ...
          ajaxUrl: function () {
            ...
            return window.appContext.urls.getLastPeriodNoByProjectIdAndTime(this.projectId, this.startTime, this.endTime);
          }.bind(this)
        },
      };
    },
    ...
    methods: {
      ...
      exportExcel() {
        ...
        let options = {
          url: window.appContext.urls.createReportData(), //请求的url
          data: {//要发送的数据
      ...
      initAllSelects() {
        window.appContext.http.getProjectPage_R(this.accountId).then((response) => {
          ...
          if (project && project.id) {
            ...
            this.startTime = $('#startTime').val();
            this.endTime = $('#endTime').val();
            window.appContext.http.getThisPeriodNo(this.projectId, this.startTime, this.endTime).then((response) => {
              let period = response.body[0];
              if (period && period.id) {
            ...
            window.appContext.http.getLastPeriodNo(this.projectId, this.startTime, this.endTime).then((response) => {
              let period = response.body[0];
              if (period && period.id) {
