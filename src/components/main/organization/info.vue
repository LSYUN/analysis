            ...
            <div class="box-body">
              ...
              <div class="div-margin-bottom">
                ...
                <div class="col-xs-9 col-sm-10 col-lg-11">
                  <input type="text" class="form-control" name="name" v-model="info.name" v-validate:login-name="['required']"
              ...
              <input name="organizationType" v-model="info.organizationType" style="display: none">
              <div class="div-margin-bottom">
                <div class="col-xs-3 col-sm-2 col-lg-1"><label><span class="span-necessary">*</span>请选择机构角色:</label>
                </div>
                <div class="col-xs-9 col-sm-10 col-lg-11">
                  <select class="form-control" v-model="info.organizationRoleId">
                    <option value="" title="请选择机构类型" v-bind:selected="!info.organizationRoleId" disabled>请选择机构角色
                    </option>
                    <option v-for="option in organizationRoles" :value="option.value"
                            :selected="option.value === info.organizationRoleId ? true : false">{{ option.text }}
                    </option>
                  </select>
                </div>
              </div>
              <input name="organizationRoleId" v-model="info.organizationRoleId" style="display: none">
              <div class="div-margin-bottom">
                <div class="col-xs-3 col-sm-2 col-lg-1"><label for="inputName"><span class="span-necessary">*</span>
                  平台小标题设置:</label></div>
                <div class="col-xs-9 col-sm-10 col-lg-11">
                  <input type="text" class="form-control" name="subHeadline" v-model="info.subHeadline" v-validate:login-name="['required']"
                         id="subHeadline" placeholder="请设置平台小题">
                  <div class="errors vue-error-bottom">
                    <p v-if="$validation.loginName.dirty && $validation.loginName.required">
                      请设置平台小标题</p>
                  </div>
              ...
              <div class="div-margin-bottom">
                <div class="col-xs-3 col-sm-2 col-lg-1"><label for="inputName"><span class="span-necessary">*</span>
                  平台大标题设置:</label></div>
                <div class="col-xs-9 col-sm-10 col-lg-11">
                  <input type="text" class="form-control" name="headline" v-model="info.headline" v-validate:login-name="['required']"
                         id="inputHeadline" placeholder="请设置平台大题">
                  <div class="errors vue-error-bottom">
                    <p v-if="$validation.loginName.dirty && $validation.loginName.required">请设置平台大标题</p>
                  </div>
                </div>
              </div>
              <div class="div-margin-bottom">
              ...
              <input name="address" v-model="info.address" style="display: none">
              <div class="div-margin-bottom">
              ...
              <div class="div-margin-bottom">
                <div class="col-xs-4 col-sm-2 col-lg-1">
                  <label><span class="span-necessary">*</span>上传logo图片</label>
                </div>
              ...
              <div class="div-margin-bottom">
                ...
                <div class="col-xs-9 col-sm-10 col-lg-11">
                  <textarea class="form-control" rows="3" name="remark" v-model="info.remark" placeholder=""></textarea>
                </div>
              </div>
            </div>
      ...
      <div id="mapDiv" class="mapDiv">
        <div class="input-wrap">
          <div class="col-xs-6 div-margin-bottom">
            <div class="input-group">
              <span class="input-group-addon">经度</span>
              <input type="number" id="nwe-lng" name="lng" class="form-control" v-model="newLng">
            </div>
          </div>
          <div class="col-xs-6 div-margin-bottom">
            <div class="input-group">
              <span class="input-group-addon">纬度</span>
              <input type="number" id="new-lat"  name="lat" class="form-control" v-model="newLat">
            </div>
          </div>
        </div>
    ...
    methods: {
      confirm () {
        ...
        if (!this.info.address) {
          toastr.info('请选择完整的机构地址');
          return;
        }
        let info = {};
        info.id = this.info.id;
        info.name = this.info.name;
        info.subhead = this.info.subhead;
        info.headline = this.info.headline;
        ...
        info.organizationRoleId = this.info.organizationRoleId;
        info.headline = this.info.headline;
        info.subHeadline = this.info.subHeadline;
        info.logoContent = this.info.logoContent;
        console.log(info.logoContent);
